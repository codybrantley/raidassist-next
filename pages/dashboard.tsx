  ...
  return(
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 2xl:gap-8">
        <div className="col-span-1 bg-gray-700 rounded-lg px-4 lg:px-8 py-4 lg:py-6">
            <h2 className="text-xl text-blue-200 font-bold mb-4 lg:mb-6">Monthly target</h2>
            <div className="flex space-x-4 items-end mb-4 lg:mb-6">
                ...
                <span className="text-blue-100 opacity-70 mb-2 whitespace-pre hidden xl:inline-block">/ &euro;40.000</span>
            </div>
            <div className="rounded-full bg-gray-600 h-7 overflow-hidden">
                <div style={{width: '65%'}} className="bg-green-400 h-7 rounded-full text-center text-green-50 flex items-center justify-center">
                    65%
                </div>
            </div>
        </div>
        <div className="col-span-1 bg-gray-700 rounded-lg px-4 lg:px-8 py-4 lg:py-6">
            <h2 className="text-xl text-blue-200 font-bold mb-4 lg:mb-6">Customers</h2>
            <div className="flex space-x-4 items-end mb-4 lg:mb-6">
                <div className="w-12 h-12 rounded-lg bg-blue-900 flex items-center justify-center">
                    <svg className="w-6 h-6 text-blue-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <span className="text-green-600 text-base mb-2 bg-green-200 border-full px-3 rounded-full">&#8605; 32</span>
            </div>
            <p>Customers this month</p>
        </div>
        <div className="col-span-1 bg-gray-700 rounded-lg px-4 lg:px-8 py-4 lg:py-6">
            <h2 className="text-xl text-blue-200 font-bold mb-4 lg:mb-6">Sales</h2>
            <div className="flex space-x-4 items-end mb-4 lg:mb-6">
                <div className="w-12 h-12 rounded-lg bg-blue-900 flex items-center justify-center">
                    <svg className="w-6 h-6 text-blue-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
