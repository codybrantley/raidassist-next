      ...
      <div className="flex font-semibold text-blue-100 text-base subpixel-antialiased">
        <div className="flex-1 flex bg-gray-800 py-8 px-4">
          <div className="container mx-auto">
            <nav className="mb-2">
              <ul className="text-base pt-2 grid gap-8 grid-cols-3">
                <li>
                  <Link
                    href="/dashboard"
                    className="bg-gray-700 text-blue-100 hover:bg-gray-700 transition-colors duration-100 flex items-end py-3 px-4 space-x-2 rounded-lg font-bold text-opacity-70 hover:text-opacity-100"
                  >
                    <svg
                      width="24"
                      height="24"
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="flex-1">Raids</span>
                  </Link>
                </li>
                <li>
                  <Link
